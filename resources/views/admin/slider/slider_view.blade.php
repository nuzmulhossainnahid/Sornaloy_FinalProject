        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" action="create_slider" method="POST" enctype="multipart/form-data">
                    @csrf
                  <div class="form-group">
                    <label for="exampleInputName1">Title</label>
                    <input type="text" class="form-control" name="sliderTitle" id="exampleInputName1" placeholder="Enter Slider Title">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail3">Text</label>
                    <input type="text" class="form-control" name="sliderText" id="exampleInputEmail3" placeholder="Enter Slider Text">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword4">Btn Text</label>
                    <input type="text" name="sliderBtn" class="form-control" id="exampleInputPassword4" placeholder="Enter Slider Btn Text">
                  </div>
                  <div class="form-group">
                    <label for="exampleSelectGender">Btn Link</label>
                    <input type="text" name="link" class="form-control" id="exampleInputPassword4" placeholder="Enter Slider Btn Link">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                          <div class="card">
                            <div class="card-body">
                              <h4 class="card-title d-flex">Slider Image</h4>
