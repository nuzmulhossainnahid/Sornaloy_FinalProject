...
<div class="col-12 grid-margin stretch-card" style="margin-top: 20px">
    <div class="text-center" style="font-size: xx-large; color: #0b0b0b">{{$bankName}}</div>
    <h5 class="text-center" style="font-size: x-large;margin-bottom: 10px; color: #0b0b0b"; >Date: {{$date}}</h5>
    ...
    <div class="col-md-6">
        <a href="{{ url('submit_bank_secdule',$data->id) }}">
        <div class="card">
            <div class="card-body">
