    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-2 col-lg-2 col-md-12 col-sm-6 col-6">
                <!-- logo -->
                <div class="logo">
                    <a href="index.html"><img src="user/logo/logo.png" alt="Borrow - Loan Company Website Template"></a>
                </div>
            </div>
            <!-- logo -->
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                  <div id="navigation">
                    ...
                    <ul>
                        ...
                        <li><a href="" class="animsition-link">Apply Loan</a>
                            <ul>
                                <li><a href="{{ url('loan_calculator') }}" class="animsition-link">Loan Calclute</a></li>
                                <li><a href="{{ url('howToApply') }}" title="About us" class="animsition-link">How to Apply</a></li>
                                <li><a href="{{ url('apply_loan') }}" title="Team" class="animsition-link">Apply</a></li>
                            </ul>
                        </li>
              ...
              <li class="nav-item">
                <a class="nav-link fw-bolder" style="color: red" href="{{ route('login') }}">login</a>
              </li>

              <li class="nav-item">
                <a class="nav-link fw-bolder" style="color: red" href="{{ route('register') }}">Registation</a>
              </li>
              @endauth
              @endif
