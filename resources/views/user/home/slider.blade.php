<div class="slider" id="slider">
    <!-- slider -->
    <div class="slider-img"><img src="user/images/slider-1.jpg" alt="Borrow - Loan Company Website Template" class="">
        <div class="container">
    ...
    <div>
        <div class="slider-img"><img src="user/images/slider-2.jpg" alt="Borrow - Loan Company Website Template" class="">
            <div class="container">
    ...
    <div>
        <div class="slider-img"><img src="user/images/slider-3.jpg" alt="Borrow - Loan Company Website Template" class="">
            <div class="container">
                <div class="col-xl-6 col-lg-6 col-md-12  col-sm-12 col-12">
                    <div class="slider-captions">
                        <!-- slider-captions -->
